...
Веб-приложение для загрузки изображений в Google Drive с использованием Service Account. Приложение может запускаться как [Web App](https://core.telegram.org/bots/webapps) в Telegram-боте и отправлять результат загрузки пользователю.
